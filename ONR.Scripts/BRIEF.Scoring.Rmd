...
Additionally, we will need to create a conversion table. This will be done outside of this script manually onto an excel sheet that will be imported. 
...
paste("Number of participants with full inhibition data:", length(unique(Inhibition.cleaned.age$ID)))
paste("Number of participants with full inhibition data:", length(unique(Working.Memory.cleaned.age$ID)))
