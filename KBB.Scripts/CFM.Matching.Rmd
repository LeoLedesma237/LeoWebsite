...
Excel 3 is also important. Just like above, we CANNOT save this information on the website. We will need to create another script to do fuzzy matching to inform our team members which ID's that need to be manually cleaned to hopefully increase our recruitment numbers. 
