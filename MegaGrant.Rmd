...
**Step 4**: Now that we have our cleaned rsEEG files, we need to process them using Fast Fourier transform to convert them into the frequency domain from the time domain. This process was done using MATLAB scripts. This Rmarkdown will now be showing that process but instead cleaning the outputs created from FFT. [[Click here to view the script]](https://leoledesma237.github.io/LeoWebsite/MegaGrant.Scripts/Frequency.Band.Scoring.html)
