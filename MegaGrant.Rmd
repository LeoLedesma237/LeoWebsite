...
**Step 3**: As mentioned in step 2, even though we identified our ideal N for our analysis, this would only be possible if all rsEEG recordings had no issues throughout the preprocessing pipeline. [[rename.link]](https://leoledesma237.github.io/LeoWebsite/MegaGrant.Scripts/Verify.rsEEG.html)
