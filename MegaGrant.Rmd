...
**Step 4**: Now that we have our cleaned rsEEG files, we need to process them using Fast Fourier transform to convert them into the frequency domain from the time domain.  
